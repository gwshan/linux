...
/*
 * The reserved memory size is 512MB, expected to be larger than
 * two times of LLC size. It means LLC size shouldn't exceed 256MB.
 ...
 */
#define TEST_CACHE_MEM_SIZE	0x20000000	/* 512MB */
